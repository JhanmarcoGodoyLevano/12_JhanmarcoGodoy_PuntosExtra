...
descargarCSVBtn.addEventListener('click', function () {
  ...
  const filename = 'personListador_NombreApellidos_Activos.csv';
  ...
  descargarExcelBtn.addEventListener('click', function() {
    ...
    var filename = 'personListador_NombreApellidos_Activos.xlsx';
  ...
  botonDescargarPDF.addEventListener('click', () => {
    ...
    const options = {
      filename: 'personListador_NombreApellidos_Activos.pdf',
