											...
											<form action="Controlador" method="POST">
												...
												<div class="modal fade" id="confirmModal" tabindex="-1"
													...
													<div class="modal-dialog">
														<div class="modal-content">
															<div class="modal-header">
																<h5 class="modal-title" id="confirmModalLabel">ALERTA:
...
descargarCSVBtn.addEventListener('click', function () {
  ...
  const filename = 'Listado_Person_Inactivos.csv';
  ...
  descargarExcelBtn.addEventListener('click', function() {
    ...
    var filename = 'Listado_Person_Inactivos.xlsx';
  ...
  botonDescargarPDF.addEventListener('click', () => {
    ...
    const options = {
      filename: 'Listado_Person_Inactivos.pdf',
