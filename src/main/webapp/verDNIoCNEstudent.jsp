										...
										<div class="card-body">
											<div id="resultContainer">
													...
													<div class="col-6 mb-3">
														<div class="form-group">
															<label for="txtGrade">Grado:</label> <select
																...
																<option value="" disabled selected>Eliga su
																	grado</option>
													...
													<div class="col-6 mb-3">
														<div class="form-group">
															<label for="txtSection">Seccion:</label> <select
																...
																<option value="" disabled selected>Eliga su Seccion</option>
												...
												<div class="row">
													...
													<div class="col-6 mb-3">
														<label for="txtPhone_proxy">TELEFONO del apoderado:</label> <input type="text"
															class="form-control" name="txtPhone_proxy"
															value="${student.getPhone_proxy()}">
													</div>
