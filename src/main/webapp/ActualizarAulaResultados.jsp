...
<body>
	...
	out.print("selected");%>>Tarde</option>
						...
						<div class="text-left">
							<input type="submit" class="btn btn-success w-25" name="accion"
								value="Buscar para Pasar de Año">
								...
								<tbody>
									<c:forEach var="student" items="${students}" varStatus="loop">
										<tr>
											...
											<td class="table-cell">
												<div class="form-group">
													<label for="txtSection">SECCION:</label> <select
														...
														<option value="" disabled>Elija su Sección</option>
											...
											<td class="table-cell">
												<div class="form-group">
													<label for="txtTurn">TURNO:</label> <select
														...
														<option value="" disabled>Elija su Turno</option>
											...
											<td>
												<!-- Campo oculto para enviar el ID del estudiante --> <input
												type="hidden" name="txtid" value="${student.getId()}">
											</td>
										</tr>
									</c:forEach>
								</tbody>
    ...
    <input type="submit" class="btn btn-success w-75" value="Actualizar">
</div>
